...
//////////////////////////////////////////////////////////////////////////
//
//	class K197    A Keithley 197 Multimeter
...
// Read()
//  reads the currently displayed value, in the current range
...
double K197::Read()
{
	...
	if (address != 0)
      ...
      else return 999.99;//if address is 0 return 'funny value'

	if (status != 0)     // On error
	{
		ErrorCode = 1;
		sprintf(ErrorMessage,"Failure reading K197 at address %d", address);
	}
